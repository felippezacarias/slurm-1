...
//NISHTALA: responsible for intializing cgroups and confining mem limits
extern int task_cgroup_memory_init(slurm_cgroup_conf_t *slurm_cgroup_conf)
{
    ...
    //NISHTALA: Current setup of cgroup paths.. is given above
...
//NISHTALA: track/suspend/resume job tasks
