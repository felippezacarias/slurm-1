...
//NISHTALA: Gather stats from cgrousp
//NISHTALA: task_cpuacct_cg is initialized in plugins/jobacct_gather/cgroup/jobacct_gather_cgroup_cpuacct.c or cgroup_mem.c or sorts
 ...
 *    wrong.
 *    NISHTALA: CALL FOR CGROUP DATA
 *    NISHTALA: Called by common/slurm_jobacct_gather.c
 */
