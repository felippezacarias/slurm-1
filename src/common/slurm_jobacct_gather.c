...
static void _acct_kill_step(void)
{
    ...
    //NISHTALA: Don't kill the job, just act as if it was a blip and continue
	req.signal      = SIGCONT;
	//req.signal      = SIGKILL;
	req.flags       = 0;
...
//NISHTALA: important start function
...
//NISHTALA: plugins/jobacct_gather/common/common_jag.c calls this guy to kill the job. (line 808)
